  ...
  return (
    <div className="min-h-screen px-7 py-10 max-w-[1100px] mx-auto">
      <div className="flex justify-between items-center mb-10">
        ...
        <div className="flex gap-3">
          <Link
            ...
            className="gradient-bg text-white font-display font-semibold text-sm px-5 py-3 facet-btn"
          >
            + Add listing
          </Link>
          <SignOutButton />
      ...
      <div className="border border-[var(--line)]">
        ...
        {items.length === 0 && (
          <div className="px-5 py-10 text-center text-[var(--ash-dim)] text-sm">No listings yet — add your first one.</div>
        )}
        {items.map((item) => (
